<div class="--dark-theme m-0" id="chat">
    <div class="chat__conversation-board">


        @foreach($messages as $message)
            <div
                class="chat__conversation-board__message-container {{$message->sender=="user" ? "reversed" : ""}} ">
    ...
    <form action="{{route('mg.store_message',['office'=>$office->id,'user'=>$default_user->id])}}" method="post">
        {{csrf_field()}}
