...
Route::group(['middleware' => ['member.auth']], function () {
    ...
    Route::group(['middleware' => ['office.active']], function () {
...
Route::group(['middleware' => ['user.auth']], function () {
    ...
    Route::get('/user/rfp', 'App\Http\Controllers\User\ProposalController@index')->name('user_rfp');
    ...
    Route::post('/user/supports/create', 'App\Http\Controllers\User\supportController@store')->name('user_support_new_ticket_store');

    Route::get('/user/messages/show/{office?}', 'App\Http\Controllers\User\messageController@index')->name('user_messages');
    Route::post('/user/messages/create/{office}', 'App\Http\Controllers\User\messageController@store')->name('user_store_message');
...
Route::group(['middleware' => ['admin.auth'], 'prefix' => 'administrator', 'namespace' => 'App\Http\Controllers\Admin'], function () {
    ...
    Route::post('/offices/edit/{office}', 'OfficeController@update')->name('admin.office.update')->middleware('admin.permission:office.*');
    ...
    Route::post('/products/edit/{product}', 'ProductController@update')->name('admin.product.update')->middleware('admin.permission:product.*');
    ...
    Route::post('/users/edit/{user}', 'UserController@update')->name('admin.user.update')->middleware('admin.permission:user.*');
    ...
    Route::post('/members/edit/{member}', 'MemberController@update')->name('admin.member.update')->middleware('admin.permission:member.*');
    ...
    Route::post('/supports/show/{support}', 'SupportController@store_message')->name('admin.support.new_message')->middleware('admin.permission:support.*');
    ...
    Route::post('/categories/edit/{category}', 'CategoryController@update')->name('admin.category.update')->middleware('admin.permission:category.*');
    Route::get('/categories/create', 'CategoryController@create')->name('admin.category.create')->middleware('admin.permission:category.*');
    Route::post('/categories/create', 'CategoryController@store')->name('admin.category.store')->middleware('admin.permission:category.*');
    ...
    Route::get('/degrees', 'DegreeController@index')->name('admin.degrees')->middleware('admin.permission:degree.*');
    Route::get('/degrees/edit/{degree}', 'DegreeController@edit')->name('admin.degree.edit')->middleware('admin.permission:degree.*');
    Route::post('/degrees/edit/{degree}', 'DegreeController@update')->name('admin.degree.update')->middleware('admin.permission:degree.*');
    Route::get('/degrees/create', 'DegreeController@create')->name('admin.degree.create')->middleware('admin.permission:degree.*');
    Route::post('/degrees/create', 'DegreeController@store')->name('admin.degree.store')->middleware('admin.permission:degree.*');
    Route::get('/degrees/remove/{degree}', 'DegreeController@remove')->name('admin.degree.remove')->middleware('admin.permission:degree.*');

    Route::get('/departments', 'DepartmentController@index')->name('admin.departments')->middleware('admin.permission:department.*');
    Route::get('/departments/edit/{department}', 'DepartmentController@edit')->name('admin.department.edit')->middleware('admin.permission:department.*');
    Route::post('/departments/edit/{department}', 'DepartmentController@update')->name('admin.department.update')->middleware('admin.permission:department.*');
    Route::get('/departments/create', 'DepartmentController@create')->name('admin.department.create')->middleware('admin.permission:department.*');
    Route::post('/departments/create', 'DepartmentController@store')->name('admin.department.store')->middleware('admin.permission:department.*');
    Route::get('/departments/remove/{department}', 'DepartmentController@remove')->name('admin.department.remove')->middleware('admin.permission:department.*');

    Route::get('/ranks', 'RankController@index')->name('admin.ranks')->middleware('admin.permission:rank.*');
    Route::get('/ranks/edit/{rank}', 'RankController@edit')->name('admin.rank.edit')->middleware('admin.permission:rank.*');
    Route::post('/ranks/edit/{rank}', 'RankController@update')->name('admin.rank.update')->middleware('admin.permission:rank.*');
    Route::get('/ranks/create', 'RankController@create')->name('admin.rank.create')->middleware('admin.permission:rank.*');
    Route::post('/ranks/create', 'RankController@store')->name('admin.rank.store')->middleware('admin.permission:rank.*');
    Route::get('/ranks/remove/{rank}', 'RankController@remove')->name('admin.rank.remove')->middleware('admin.permission:rank.*');
    ...
    Route::post('/reports/types/edit/{report_type}', 'ReportTypeController@update')->name('admin.reports.type.update')->middleware('admin.permission:report.*');
    ...
    Route::post('/reports/types/create', 'ReportTypeController@store')->name('admin.reports.type.store')->middleware('admin.permission:report.*');
    ...
    Route::get('/tags', 'TagController@index')->name('admin.tags')->middleware('admin.permission:tag.*');
    Route::get('/tags/edit/{tag}', 'TagController@edit')->name('admin.tag.edit')->middleware('admin.permission:tag.*');
    Route::post('/tags/edit/{tag}', 'TagController@update')->name('admin.tag.update')->middleware('admin.permission:tag.*');
    Route::get('/tags/create', 'TagController@create')->name('admin.tag.create')->middleware('admin.permission:tag.*');
    Route::post('/tags/create', 'TagController@store')->name('admin.tag.store')->middleware('admin.permission:tag.*');
    Route::get('/tags/remove/{tag}', 'TagController@remove')->name('admin.tag.remove')->middleware('admin.permission:tag.*');
